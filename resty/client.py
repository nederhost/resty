...
class Client:
    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.serializer: self.serializer.set_client(self)
        if self.parser: self.parser.set_client(self)
        if self.auth: self.auth.set_client(self)
        if self.transport: self.transport.set_client(self)
